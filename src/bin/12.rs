    ...
    let (east, north, _) = input
        ...
        .fold((0, 0, Direction::East), |(east, north, facing), (action, n)|
            match (action, n, facing) {
                ...
                (Action::Left, 90, facing) | (Action::Right, 270, facing) => (east, north, facing.rotate_left()),
                (Action::Left, 270, facing) | (Action::Right, 90, facing) => (east, north, facing.rotate_right()),
...
pub fn part_two(input: &str) -> Option<u32> {
    let (east, north, _, _) = input
        ...
        .fold((0, 0, 10, 1), |(east, north, wp_east, wp_north), (action, n)|
            match (action, n) {
                ...
                (Action::Forward, n) => (east + n * wp_east, north + n * wp_north, wp_east, wp_north),
